...
class PolyRegion:
    ...
    def inRegion(self,requiredMeasureTypes,scalingFactor=1):
    ...
    def outRegion(self,requiredMeasureTypes,scalingFactor=1):
    ...
    def inControlRegion(self,requiredMeasureTypes,scalingFactor=1):
    ...
    def inRollRegion(self,requiredMeasureTypes,scalingFactor=1):
